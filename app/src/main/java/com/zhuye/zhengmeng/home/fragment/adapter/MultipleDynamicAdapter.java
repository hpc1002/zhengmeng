    ...
    protected void convert(BaseViewHolder helper, DynamicModel.DataBean item) {
        switch (helper.getItemViewType()) {
            case DynamicModel.DataBean.MP3:
                helper.setText(R.id.userName, item.getUser_nicename().equals("") ? "" : item.getUser_nicename());
                ...
                helper.setText(R.id.production_name, item.getSong_name().equals(" ") ? "未知歌曲名" : item.getSong_name());//作品名称
            ...
            case DynamicModel.DataBean.MP4:
                ...
                helper.setText(R.id.production_name, item.getSong_name().equals(" ") ? "未知视频名" : item.getSong_name());//作品名称
                helper.setText(R.id.production_content, item.getProduction_content());//作品内容
                break;
        }
    }
