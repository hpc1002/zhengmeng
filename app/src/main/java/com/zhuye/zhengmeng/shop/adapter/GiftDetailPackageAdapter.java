...
public class GiftDetailPackageAdapter extends BaseQuickAdapter<GiftDetailBean.Data.KnapsackLlist, BaseViewHolder> {
    public GiftDetailPackageAdapter(int layoutResId, @Nullable List<GiftDetailBean.Data.KnapsackLlist> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, GiftDetailBean.Data.KnapsackLlist item) {
