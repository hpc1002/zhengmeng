...
public class ClothShopFragment extends BaseNoFragment {
    @BindView(R.id.recyclerView)
    RecyclerView recyclerView;
    Unbinder unbinder;
    private String token;
    private static final String TAG = "ClothShopFragment";
    private String score;

    @Override
    protected View initView(LayoutInflater inflater, ViewGroup container) {
        return inflater.inflate(R.layout.fragment_cloth_shop, container, false);
    }

    @Override
    protected void initListener() {
        token = SPUtils.getInstance("userInfo").getString("token");
        DreamApi.getClothListUrl(0x001, token, myCallBack);
    }
                ...
                case 0x001:
                    try {
                        ...
                        if (code == 200) {
                            ...
                            Log.i(TAG, "onSuccess:服饰id查询 " + data.get(3).gift_id);
        ...
        quick_duihuan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (retval > 0) {
                    ...
                    DreamApi.buyGoodUrl(0x002, token, giftId, num, "3", myCallBack);
                }
