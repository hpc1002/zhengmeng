...
public class SendGiftListAdapter extends BaseQuickAdapter<GiftListBean.Data, BaseViewHolder> {
    private Context context;

    public SendGiftListAdapter(int layoutResId, @Nullable List<GiftListBean.Data> data, Context context) {
