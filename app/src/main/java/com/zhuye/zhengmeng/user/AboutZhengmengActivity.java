...
public class AboutZhengmengActivity extends BaseActivity {
    ...
    protected void processLogic() {
        DreamApi.aboutUs(0x001, this, token, myCallBack);
    }
    ...
    protected void loadViewLayout() {
        setContentView(R.layout.activity_about_zhengmeng);
    }
