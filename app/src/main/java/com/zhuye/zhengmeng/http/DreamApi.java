...
public class DreamApi {
    ...
    //添加收藏
    public static void addCollectList(final int what, String token,
...
//                        Log.i(TAG, "onSuccess:rawCookies " + rawCookies);
    ...
    //用户更新是否在线
    public static void ifOnline(final int what, String token,String chatroom_id,final MyCallBack myCallBack) {
        OkGo.<String>post(Constant.IFONLINE_URL)
                .tag(App.getInstance())
                .params("token", token)
                .params("chatroom_id", chatroom_id)
                .execute(new StringCallback() {
    ...
    //加入房间
    public static void joinRoom(final int what, String token,String chatroom_id,final MyCallBack myCallBack) {
        OkGo.<String>post(Constant.JOIN_ROOM_URL)
                .tag(App.getInstance())
                .params("token", token)
                .params("chatroom_id", chatroom_id)
                .execute(new StringCallback() {
    ...
    //加入房间
    public static void shareRoom(final int what, String token,String chatroom_id,final MyCallBack myCallBack) {
        OkGo.<String>post(Constant.SHARE_ROOM_URL)
                .tag(App.getInstance())
                .params("token", token)
                .params("chatroom_id", chatroom_id)
                .execute(new StringCallback() {
    ...
    //加入房间
    public static void feedback(final int what, String token,String content,final MyCallBack myCallBack) {
